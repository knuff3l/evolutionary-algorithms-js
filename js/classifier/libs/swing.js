...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sister__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sister___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_sister__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hammerjs__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hammerjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_hammerjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rebound__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rebound___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rebound__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vendor_prefix__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vendor_prefix___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_vendor_prefix__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_raf__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_raf___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_raf__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Direction__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__utilities__ = __webpack_require__(16);
...
const computeDirection = (fromX, fromY, allowedDirections) => {
  ...
  const isLeftDirection = fromX < 0 ? __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].LEFT : __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].RIGHT;
  const isUpDirection = fromY < 0 ? __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].UP : __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].DOWN;

  const direction = isHorizontal ? isLeftDirection : isUpDirection;

  if (allowedDirections.indexOf(direction) === -1) {
    return __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].INVALID;
  }
...
const Card = (stack, targetElement) => {
  ...
  const construct = () => {
    ...
    eventEmitter = __WEBPACK_IMPORTED_MODULE_1_sister___default()();
    ...
    throwDirectionToEventName[__WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].LEFT] = 'throwoutleft';
    throwDirectionToEventName[__WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].RIGHT] = 'throwoutright';
    throwDirectionToEventName[__WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].UP] = 'throwoutup';
    throwDirectionToEventName[__WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].DOWN] = 'throwoutdown';
    ...
    mc = new __WEBPACK_IMPORTED_MODULE_2_hammerjs___default.a.Manager(targetElement, {
      recognizers: [
        [
          __WEBPACK_IMPORTED_MODULE_2_hammerjs___default.a.Pan,
          {
            threshold: 2
          }
        ]
    ...
    eventEmitter.on('panstart', () => {
      ...
      (function animation () {
        if (isDraging) {
          ...
          __WEBPACK_IMPORTED_MODULE_5_raf___default()(animation);
        }
      })();
    });
    ...
    eventEmitter.on('panend', (event) => {
      ...
      if (isThrowOut && direction !== __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].INVALID) {
    ...
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utilities__["a" /* isTouchDevice */])()) {
    ...
    springThrowIn.addListener({
      ...
      onSpringUpdate: (spring) => {
        ...
        const coordianteX = __WEBPACK_IMPORTED_MODULE_3_rebound___default.a.MathUtil.mapValueInRange(value, 0, 1, lastThrow.fromX, 0);
        const coordianteY = __WEBPACK_IMPORTED_MODULE_3_rebound___default.a.MathUtil.mapValueInRange(value, 0, 1, lastThrow.fromY, 0);
    ...
    springThrowOut.addListener({
      ...
      onSpringUpdate: (spring) => {
        ...
        if (lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].RIGHT || lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].LEFT) {
          directionFactor = lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].RIGHT ? 1 : -1;
          coordianteX = __WEBPACK_IMPORTED_MODULE_3_rebound___default.a.MathUtil.mapValueInRange(value, 0, 1, lastThrow.fromX, throwOutDistance * directionFactor);
          coordianteY = lastThrow.fromY;
        } else if (lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].UP || lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].DOWN) {
          directionFactor = lastThrow.direction === __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].DOWN ? 1 : -1;
          coordianteX = lastThrow.fromX;
          coordianteY = __WEBPACK_IMPORTED_MODULE_3_rebound___default.a.MathUtil.mapValueInRange(value, 0, 1, lastThrow.fromY, throwOutDistance * directionFactor);
        }
...
Card.makeConfig = (config = {}) => {
  const defaultConfig = {
    allowedDirections: [
      __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].RIGHT,
      __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].LEFT,
      __WEBPACK_IMPORTED_MODULE_6__Direction__["a" /* default */].UP
    ],
  ...
  return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.assign({}, defaultConfig, config);
};
...
Card.transform = (element, coordinateX, coordinateY, rotation) => {
  element.style[__WEBPACK_IMPORTED_MODULE_4_vendor_prefix___default()('transform')] = 'translate3d(0, 0, 0) translate(' + coordinateX + 'px, ' + coordinateY + 'px) rotate(' + rotation + 'deg)';
};
...
Card.appendToParent = (element) => {
  ...
  const siblings = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utilities__["b" /* elementChildren */])(parentNode);
...
Card.throwOutDistance = (min, max) => {
  return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.random(min, max);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sister__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sister___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_sister__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rebound__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rebound___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rebound__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Card__ = __webpack_require__(3);
...
const Stack = (config) => {
  ...
  const construct = () => {
    stack = {};
    springSystem = new __WEBPACK_IMPORTED_MODULE_2_rebound___default.a.SpringSystem();
    eventEmitter = __WEBPACK_IMPORTED_MODULE_1_sister___default()();
    index = [];
  };
  ...
  stack.createCard = (element) => {
    const card = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__Card__["a" /* default */])(stack, element);
    const events = [
      'throwout',
      'throwoutend',
      'throwoutleft',
  ...
  stack.getCard = (element) => {
    const group = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.find(index, {
      element
    });
   ...
   */
  stack.destroyCard = (card) => {
    return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.remove(index, {
      card
    });
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Direction__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Stack__ = __webpack_require__(7);
...
window.swing = {
  ...
  Direction: __WEBPACK_IMPORTED_MODULE_1__Direction__["a" /* default */],
  Stack: __WEBPACK_IMPORTED_MODULE_2__Stack__["a" /* default */]
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return elementChildren; });
...
const elementChildren = (element) => {
  return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.filter(element.childNodes, {
    nodeType: 1
  });
};
